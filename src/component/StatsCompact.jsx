...
/* =========================
   MAIN COMPONENT
========================= */
const StatsCompact = ({ badge, title, description }) => {
  const stats = [
    {
      icon: "fas fa-code",
      target: 4,
      ...
      <div className="container">
        ...
        {(badge || title || description) && (
          <div className="text-center mb-4">
            ...
            {badge && (
              <span className="section-statbadge">
                <i className="fas fa-chart-line me-1"></i> {badge}
              </span>
            )}

            {title && (
              <h2 className="section-stattitle">{title}</h2>
            )}
